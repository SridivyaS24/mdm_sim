...
import { Radio, RadioGroup, FormControlLabel, FormControl, Stack, Button, Typography, Box, TextField, Grid, Paper } from '@mui/material';
import { simTypes, DCU } from "../utils/Dropdowns";
        ...
        <Grid container direction="row" alignContent="Center" justifyContent="center" spacing={2}>
          ...
          <Grid item xs={3} >
            <FormControl component="fieldset">
              ...
              <RadioGroup row aria-label="IP type" name="ipType" value={(values.ipType)}
                onChange={handleInputChange} >
          ...
          <Grid item xs={3}>
            <FormControl component="fieldset">
              ...
              <RadioGroup row aria-label="Type of IP" name="typeOfIp" value={values.typeOfIp}
                onChange={handleInputChange}>
